     ...
     <div className="container px-4 md:px-6 flex flex-col items-center justify-center text-center">
        <h3 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl mb-8">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Our chatbot SDK comes with a lot of features that you can use to make your chatbot more powerful.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  We use OpenAI Assistant to power our chatbots. You can use GPT-4, GTP-3.5, GPT-4o and GPT-4o-mini
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  You can customize the chatbot to match your website&apos;s design.
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  Our library is fully open source. You can find the code on Github to contribute to the project with the community.
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  Our chatbot saves the user chat history in the local storage and you can access it anytime.
                </p>
              </div>
            </div>
          </div>
