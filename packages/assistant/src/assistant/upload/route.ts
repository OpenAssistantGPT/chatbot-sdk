...
const FileSchema = z.object({
  file: z
    ...
    .refine(
      ...
      {
        message: "Unsupported file type. Only C, CS, CPP, DOC, DOCX, HTML, JAVA, JSON, MD, PDF, PHP, PPTX, PY, RB, TEX, TXT, CSS, JS, SH, TS, CSV, JPEG, JPG, GIF, PNG, TAR, XLSX, XML, and ZIP are accepted.",
      },
    ),
});
